...
function _sprintf(mod, fmt, value) {
    if(is_num(value)) return sprintf(
...
// cursor
global.move_up      = n => out.write(esc + (is_num(n) ? n : '') + 'A');
global.move_down    = n => out.write(esc + (is_num(n) ? n : '') + 'B');
global.move_forward = n => out.write(esc + (is_num(n) ? n : '') + 'C');
global.move_back    = n => out.write(esc + (is_num(n) ? n : '') + 'D');

global.move_next    = n => out.write(esc + (is_num(n) ? n : '') + 'E');
global.move_prev    = n => out.write(esc + (is_num(n) ? n : '') + 'F');
...
// screen
global.scroll_up   = n => out.write(esc + (is_num(n) ? n : '') + 'S');
global.scroll_down = n => out.write(esc + (is_num(n) ? n : '') + 'T');
